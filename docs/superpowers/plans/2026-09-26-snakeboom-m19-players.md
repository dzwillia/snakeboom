...
- [ ] Commit `feat(sim): matches of up to eight players`.
...
- [ ] Commit `feat(net): rollback sessions for up to eight seats`.
...
- [ ] Commit `feat(relay): rooms of up to eight`.
...
- [ ] Commit `feat(client): eight-player lobbies, HUD, camera and banners`.
