...
- **Tuning that scales with the map:** border speeds double (24 / 240 units/s), pickups up to 12 with one every second and a 300-unit distance from heads. Snake speed stays 280 for the first playtest.
