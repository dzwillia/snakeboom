 ...
 * Updated 2026-09-25 when Turbo and Slow were removed (M9 Task 1) and again for the closing border and the pace defaults (M9 Tasks 2 and 3).
 */
const GOLDEN_HASH = 0x27f21115;
