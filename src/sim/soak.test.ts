...
describe('soak', () => {
  ...
  const extremes: Array<[string, Partial<Config>]> = [
    ...
    [
      'shields only',
      {
        pickupWeights: { missile: 0, scissors: 0, flame: 0, ghost: 0, shield: 1, dozer: 0 },
        firstPickupDelay: 0,
        pickupInterval: 1,
        maxPickups: 4,
      },
    ...
    [
      'ghosts only',
      {
        pickupWeights: { missile: 0, scissors: 0, flame: 0, ghost: 1, shield: 0, dozer: 0 },
        firstPickupDelay: 0,
        pickupInterval: 1,
        maxPickups: 4,
        ghostDuration: 10,
    ...
    [
      'dozers everywhere',
      {
        pickupWeights: { missile: 0, scissors: 0, flame: 0, ghost: 0, shield: 0, dozer: 1 },
        firstPickupDelay: 0,
        pickupInterval: 1,
        maxPickups: 4,
        dozerDuration: 10,
